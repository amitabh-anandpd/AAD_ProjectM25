...
#### Generate visuals for all batches:
```bash
...
├── graphs_v/                   # Type V random graphs (constant edges)
├── graphs_e/                   # Type E random graphs (constant edges, different base)
├── graphs2/                    # Additional graph folders (optional)
├── results/
...
│   ├── scatter_time_vs_vertices.png    # All batches combined
│   ├── scatter_time_vs_edges.png       # All batches combined
